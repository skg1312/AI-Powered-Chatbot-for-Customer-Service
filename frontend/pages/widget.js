                    ...
                    {message.role === 'user' ? (
                      ...
                      <ReactMarkdown 
                        components={{
                          ...
                          code: ({children}) => <code className="bg-gray-200 text-gray-800 px-1 py-0.5 rounded text-xs">{children}</code>,
                          pre: ({children}) => <pre className="bg-gray-200 text-gray-800 p-2 rounded text-xs overflow-x-auto mb-2">{children}</pre>
                        }}
                      >
                        {message.content}
                      </ReactMarkdown>
